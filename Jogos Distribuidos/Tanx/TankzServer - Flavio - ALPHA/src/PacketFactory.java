...
public class PacketFactory
{
	...
	/**
	 * 
	 * @param x coordinate (avatar)
	 * @param y coordinate (avatar)
	 * @param playerId 
	 * @param alive 
	 * @return
	 */
	public static DatagramPacket newPosition( double x, double y, String playerId, boolean alive )
	{
		int avatarsAmount = GamePanel.getInstance().getAvatarListSize();
		String msg = playerId + " " + x + " " + y + " " + alive + " " + avatarsAmount;
...
//	}
	...
	/**
	 * 
	 * @param x coordinate (bullet)
	 * @param y coordinate (bullet)
	 * @param vx speed (bullet)
	 * @param vy speed (bullet)
	 * @param playerId is shooting
	 * @return
	 */
	public static DatagramPacket newShoot( double x, double y, double vx, double vy, String playerId )
	{
		int bulletAmount = GamePanel.getInstance().getAvatar(playerId).bulletListSize();
//		int playerIndex = gp.getAvatarIndex(playerId);
		
		String msg = playerId + " " + x + " " + y + " " + vx + " " + vy + " " + bulletAmount;
