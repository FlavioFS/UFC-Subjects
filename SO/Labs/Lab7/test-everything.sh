...
java -classpath class Avoid "inputs/system-state2.csv" "inputs/request2.csv"
java -classpath class Avoid "inputs/system-state2.csv" "inputs/request3.csv"
java -classpath class Avoid "inputs/system-state2.csv" "inputs/request4.csv"